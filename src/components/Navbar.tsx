...
export function Navbar({ page }: NavbarProps) {
    ...
    return (
        <div>
            <aside className="fixed top-0 left-0 border-r border-black/20 dark:border-white/20 h-screen w-60 p-2 flex flex-col overflow-y-scroll scrollbar-none">
                <div className="flex items-center mb-5 gap-2">
                    <div className="relative rounded-md size-10 border border-cyan-500">
                ...
                <button onClick={ToggleConfigNav} className="fixed bottom-2 left-[12rem] border border-black/20 dark:border-white/20 rounded-md w-min bg-lightPage dark:bg-darkPage ml-auto">
