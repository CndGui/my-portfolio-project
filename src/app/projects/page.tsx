        ...
        <div>
            ...
            <main className="ml-60 max-[765px]:ml-0 max-[765px]:mt-14 py-20 px-36 max-[1220px]:px-20 max-[917px]:px-10 max-[480px]:px-4 flex flex-col gap-10">
                <div>
                    ...
                    <p className="text-zinc-600 dark:text-zinc-400">{"Here are some of the projects I ve created. If interested, see more at"} <a href="https://github.com/CndGui?tab=repositories" target="_blank" className="font-normal text-cyan-500 underline">Github</a></p>
                </div>
